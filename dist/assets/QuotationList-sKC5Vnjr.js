import{r as T,an as R,x as e,B as W,S as ne,K as ae,V as E,H as le,T as de,ao as pe,ap as z}from"./index-Bg1Zrd-H.js";import{i as G}from"./axios-YBtE4rUB.js";import{h as Y}from"./moment-C5S46NFB.js";import{D as ce}from"./index-DBkbvCey.js";import{T as oe}from"./index-D53fOJRi.js";import{D as ge,d as xe}from"./index-Dp2f_Tt8.js";import{I as ie,R as ue}from"./index-UbYnl7AJ.js";import{D as J}from"./index-DYtio2Fi.js";import{L as Z}from"./index-Dsq-rPsN.js";import{R as re}from"./MessageOutlined-BL6sdb07.js";import{E as me,h as X,R as fe}from"./html2canvas.esm-4uCvSazB.js";import{L as q,R as he}from"./Primary Logo 01-CS2eOLUD.js";import{c as ye}from"./TextArea-Dulz_D7I.js";import{F as _}from"./Table-DMSJbDzt.js";import{M as be}from"./index-B9LdEgXh.js";import{D as v}from"./index-BGR4pt_1.js";import{T as B}from"./index-CtCj0RZR.js";import{R as ee}from"./PrinterOutlined-CELZ1gfl.js";import{R as we}from"./EditOutlined-OnElItKJ.js";import{P as ve}from"./index-BMw5ERja.js";import{R as Ne}from"./DeleteOutlined-BSDkNMyd.js";import"./context-L6PQDc9-.js";import"./useClosable-CkjCEdDx.js";import"./index-DmGqokk2.js";import"./dayjs.min-vyi2hVFN.js";import"./addEventListener-CQvKumwL.js";import"./index-CBP2Uuw3.js";import"./InfoCircleFilled-B7Rg1P1t.js";import"./ActionButton-xqZuxn6w.js";import"./index-tri7UvDl.js";const{TextArea:Ie}=ie,{Text:H}=oe,je=({visible:s,onClose:g,quotation:n,refreshQuotations:p})=>{const[f,N]=T.useState(""),[u,x]=T.useState(null),[y,c]=T.useState(!1),[i,h]=T.useState([]),[d,b]=T.useState(null),[U,$]=T.useState([]),[I,C]=T.useState(!1),j=()=>{try{const r=JSON.parse(localStorage.getItem("user"));return(r==null?void 0:r.email)||"Unknown"}catch{return"Unknown"}};T.useEffect(()=>{s&&(n!=null&&n._id)?(k(),L()):(h([]),b(null),N(""),x(null),$([]))},[s,n]);const L=async()=>{C(!0);try{const r=await G.get("/api/users");Array.isArray(r.data)?$(r.data):(console.warn("API for users did not return an array:",r.data),$([]))}catch(r){console.error("Failed to fetch users:",r),R.error("Could not load user details for display."),$([])}finally{C(!1)}},M=r=>{if(!r)return"Unknown User";if(typeof r=="object"&&r!==null)return r.name||r.email||"Unknown User";const m=U.find(w=>w._id===r||w.id===r);return m?m.name||m.email||`User ID: ${r}`:`Unknown User (ID: ${r})`},k=async()=>{if(n!=null&&n._id){c(!0);try{const r=await G.get(`/api/quotations/${n._id}/followups`);h(r.data.sort((m,w)=>Y(w.createdAt).diff(Y(m.createdAt))))}catch(r){console.error("Error fetching follow-ups:",r),R.error("Failed to fetch follow-ups.")}finally{c(!1)}}},F=async()=>{if(!u||!f.trim()){R.error("Please select a date and enter a note for the follow-up.");return}c(!0);try{let r;const m=JSON.parse(localStorage.getItem("user")),w=(m==null?void 0:m._id)||(m==null?void 0:m.id);if(!w){R.error("User information not found. Please log in."),c(!1);return}const D={date:Y(u).toISOString(),note:f.trim(),addedBy:w};d===null?r=G.post(`/api/quotations/${n._id}/followups`,D):r=G.put(`/api/quotations/${n._id}/followups/${d._id}`,D),r.then(()=>{R.success(d===null?"Follow-up added successfully!":"Follow-up updated successfully!"),N(""),x(null),b(null),k(),typeof p=="function"&&p()}).catch(t=>{var o,a;console.error("Error saving follow-up:",t),R.error(`Error saving follow-up: ${((a=(o=t.response)==null?void 0:o.data)==null?void 0:a.message)||t.message}`)}).finally(()=>{c(!1)})}catch(r){console.error("Error preparing follow-up data:",r),R.error("An unexpected error occurred."),c(!1)}},P=r=>e.jsx(Z.Item,{children:e.jsxs("div",{style:{backgroundColor:"#f0f2f5",borderRadius:"12px",padding:"10px 15px",maxWidth:"calc(100% - 80px)",flexGrow:1},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",marginBottom:"5px"},children:[e.jsx(ae,{style:{marginRight:"5px",color:"#888"}}),e.jsx(H,{strong:!0,style:{marginRight:"10px",color:"#333"},children:M(r.addedBy)}),e.jsx(xe,{style:{marginRight:"5px",color:"#888"}}),e.jsx(H,{type:"secondary",style:{fontSize:"0.8em"},children:Y(r.createdAt).format("DD/MM/YYYY, h:mm:ss A")})]}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-start"},children:[e.jsx(re,{style:{marginRight:"8px",marginTop:"3px",color:"#555"}}),e.jsx(H,{style:{flexGrow:1},children:r.note})]})]})});return e.jsxs(ce,{title:`Follow-ups for Quotation: ${(n==null?void 0:n.quotationNumber)||"N/A"}`,open:s,onClose:()=>{b(null),N(""),x(null),g()},width:720,children:[e.jsxs("div",{style:{marginBottom:20},children:[e.jsxs(H,{type:"secondary",style:{marginBottom:8,display:"block",fontSize:"0.9em"},children:["Adding follow-up as: ",e.jsx(H,{strong:!0,children:j()})]}),e.jsx(ge,{style:{width:"100%",marginBottom:8},format:"DD-MM-YYYY",value:u,onChange:r=>x(r),placeholder:"Select follow-up date"}),e.jsx(Ie,{rows:4,placeholder:"Enter follow-up note",value:f,onChange:r=>N(r.target.value)}),e.jsx(W,{type:"primary",style:{marginTop:10,backgroundColor:"#ef7a1b",borderColor:"#ef7a1b",color:"white"},block:!0,onClick:F,loading:y,children:d===null?"Add Follow-up":"Update Follow-up"})]}),e.jsxs(J,{children:["All Follow-ups (",i.length,")"]}),y||I?e.jsx("div",{style:{textAlign:"center",padding:"20px"},children:e.jsx(ne,{size:"large",tip:"Loading Follow-ups..."})}):e.jsx(Z,{dataSource:i,renderItem:P,locale:{emptyText:"No follow-ups found for this quotation."},style:{marginTop:16}})]})},V=s=>`₹${(parseFloat(s)||0).toLocaleString("en-IN",{minimumFractionDigits:2,maximumFractionDigits:2})}`,Se=s=>{if(typeof s!="number"||isNaN(s))return"N/A";let g=Math.floor(s),n=Math.round((s-g)*100);const p=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine"],f=["Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],N=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],u=["","Thousand","Lakh","Crore"],x=d=>d<10?p[d]:d>=10&&d<20?f[d-10]:N[Math.floor(d/10)]+(d%10!==0?" "+p[d%10]:"");let y=[],c=0;if(g===0)y.push("Zero");else{let d=g%1e3;for(d>0&&(d<100?y.push(x(d)):y.push(p[Math.floor(d/100)]+" Hundred"+(d%100!==0?" "+x(d%100):""))),g=Math.floor(g/1e3);g>0;){let b=g%100;b>0?y.push(x(b)+" "+u[++c]):c++,g=Math.floor(g/100)}}const i=y.reverse().filter(Boolean).join(" ").trim();let h=i?i+" Rupees":"Zero Rupees";return n>0&&(h+=` and ${x(n)} Paisa`),h+=" Only",h.replace(/\s+/g," ")},Ae=s=>{var C,j,L,M,k,F,P,r,m,w,D;const g=((C=s.items)==null?void 0:C.reduce((t,o)=>t+(o.quantity||0)*(o.rate||0),0))||0,p=g*.18,f=g+p,N=q,u=q,x=((j=s.businessId)==null?void 0:j.contactName)||s.contactName||"N/A",y=s.mobileNumber||((L=s.businessId)==null?void 0:L.mobileNumber)||((M=s.businessId)==null?void 0:M.phone)||"N/A",c=((k=s.businessId)==null?void 0:k.email)||s.email||"N/A",i=((F=s.businessId)==null?void 0:F.gstin)||s.gstin||"N/A",h=((r=(P=s.businessId)==null?void 0:P.address)==null?void 0:r.replace(/\n/g,"<br>"))||((m=s.businessInfo)==null?void 0:m.replace(/\n/g,"<br>"))||"N/A",d=`
    <div style="margin-bottom: 20px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        <div style="display: flex; align-items: center;">
          <img src="${N}" alt="Company Logo" style="height: 70px; margin-right: 15px;">
          <div>
