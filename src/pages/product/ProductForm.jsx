...
const ProductForm = ({ visible, onClose, onSave, initialValues }) => {
  ...
  const handleSubmit = async (values) => {
    // ✅ Strip product_id, productId, and _id to avoid backend conflicts or sending client-generated product_id
    // product_id will now be generated by the backend for new products.
